	...
	public String invoke(String str, String defaultValue, String param , String mapName) throws MethodDealException {
		...
		if(a.startsWith("00")){
			if(a.startsWith("0086")){
				return invoke(a.substring(4) + "," + b , defaultValue,param,mapName);
			}
			return  a.substring(2);
		} else if (a.startsWith("0")){
			
			//26|17751221412|017751221412
			//26|17858828502|017858828502
			//26|17715035104|017715035104
			//26|17091779110|017091779110
			
			//26|15231701118|  a:00860152317011185
			//26|13067965775| a:0130679657759
			//22|15163616678| a:0151636166789
			if( a.startsWith("0188") || a.startsWith("0130") || a.startsWith("0152")  || a.startsWith("0151") ) {
				if(len != 12){
					return "";
				} else{
     ...
     //26|688|17960688
	  //26|688|17960688
		if(len > 5){
			if(a.startsWith("12591") || a.startsWith("12592") || a.startsWith("12593") || a.startsWith("17951")   ||  a.startsWith("17920") ||  a.startsWith("17921")
					...
					a.startsWith("17931")  || a.startsWith("17991")  || a.startsWith("17996")  || a.startsWith("17990")|| a.startsWith("17961") || a.startsWith("17969")
		...
		if(len > 3){
			...
			//26|14796409092|147964090929  异常 未解决
			//26||14777   异常 未解决
			//26||177082 异常未解决
			//26||179297
		...
		if(len >= 3) {
			if(codeLen != 0 && a.startsWith(b) ){
					//26|796|   a:796 b:796
					//26|791830|830 
					//26|7971212121212290|1212121212290
					//26|7961780|1780
					//26|7914009333333|4009333333
					return a.substring(codeLen);
				}
		}
			//26|172946|172
		/*	else if(len >= 6 && len <= 8){
		...
		if(len > 3){
			if(a.startsWith("172")){
				if(a.startsWith("17266") || a.startsWith("17200") ||a.startsWith("17201") || a.startsWith("17202")  ){
			...
			if(a.startsWith("1259") || a.startsWith("1258")){
				return a.substring(0,4);
			}
			
			if(a.startsWith("1860") || a.startsWith("1861")){
					return a.substring(0,4);
			}
		}
		
		//26|17853908282|017853908282
		/*if(len>9){
			if(a.startsWith("0") && (! a.startsWith("00"))){
				return a.substring(1);
			}
		} else {
			if(a.startsWith("0") && (!a.startsWith("00"))){
				if(a.startsWith("01") ||   a.startsWith("02")){
		...
		if(a.equals("995533")|| a.equals("995588")){
			return a;
		}
